    ...
    public ZooKeeper getZookeeper(HttpServletRequest request, HttpServletResponse response, String zkServer) {
        try {
            ...
            if (zk == null || zk.getState() != ZooKeeper.States.CONNECTED) {
                Integer zkSessionTimeout = Integer.parseInt(PropertiesConfigUtil.getString("zkSessionTimeout"));
                ...
                ZooKeeperUtil.INSTANCE.setDefaultAcl(PropertiesConfigUtil.getString("defaultAcl"));
