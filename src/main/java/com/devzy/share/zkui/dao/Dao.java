 ...
 *
 */
package com.devzy.share.zkui.dao;
...
import com.devzy.share.zkui.domain.History;
...
public class Dao {
    ...
    public void open() {
    	String driver=PropertiesConfigUtil.getString("jdbcClass");
    	String url=PropertiesConfigUtil.getString("jdbcUrl");
    	String user=PropertiesConfigUtil.getString("jdbcUser");
    	String password=PropertiesConfigUtil.getString("jdbcPwd");
    ...
    public void checkNCreate() {
        try {
            ...
            flyway.setDataSource(PropertiesConfigUtil.getString("jdbcUrl"), PropertiesConfigUtil.getString("jdbcUser"), PropertiesConfigUtil.getString("jdbcPwd"));
            //Will wipe db each time. Avoid this in prod.
            if (PropertiesConfigUtil.getString("env").equals("dev")) {
                flyway.clean();
            }
